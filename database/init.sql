...
('i9j0k1l2', '桂花-01',   '桂花',   '常绿灌木或小乔木，秋季开花，香气浓郁。'),
('m3n4o5p6', '樱花-01',   '樱花',   '春季开花，粉白色花团锦簇，花期约两周。'),
('q7r8s9t0', '悬铃木-01', '悬铃木', '落叶大乔木，树冠广阔，耐修剪，世界著名行道树。');
...
('i9j0k1l2', '一勺池旁',   ST_SetSRID(ST_MakePoint(116.312800, 39.971200), 4326), 116.312800, 39.971200),
('m3n4o5p6', '操场旁',     ST_SetSRID(ST_MakePoint(116.312100, 39.971500), 4326), 116.312100, 39.971500),
('q7r8s9t0', '世纪馆前',   ST_SetSRID(ST_MakePoint(116.315000, 39.970000), 4326), 116.315000, 39.970000);
